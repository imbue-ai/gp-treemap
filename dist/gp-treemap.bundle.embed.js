export const BUNDLE = `/* gp-treemap — single-file build (generated by tools/build.js) */
(function(){ "use strict";
const __WORKER_SRC__ = \`/* gp-treemap render-worker — built by tools/build.js */
(function(){ "use strict";
/* ---- src/hash.js ---- */
...
try { if (typeof window !== "undefined") window.__gpTreemapWorkerSrc = __WORKER_SRC__; } catch (e) {}
/* ---- src/hash.js ---- */
// FNV-1a 32-bit. Deterministic across runs; used for hash-based color assignment.
function fnv1a(str) {
  let h = 0x811c9dc5;
